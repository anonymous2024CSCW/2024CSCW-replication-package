...
data <- read_excel("data/data_for_RQ1.xlsx")
...
#New Bugs
result1 <- plm(resultBugs ~ issueEntropy + resultAge  + resultCore  + resultFile + resultForks + 
              issueEntropy:resultAge +  issueEntropy:resultCore  + issueEntropy:resultFile + issueEntropy:resultForks ,
              data = pdata , 
              model = "within")


result2 <- plm(resultBugs ~ issueEntropy + resultAge  + resultCore  + resultFile + resultForks +
              issueEntropy:resultAge +  issueEntropy:resultCore  + issueEntropy:resultFile + issueEntropy:resultForks ,
...
result3 <- plm(resultBugs ~ issueEntropy + resultAge  + resultCore  + resultFile + resultForks +
              issueEntropy:resultAge +  issueEntropy:resultCore  + issueEntropy:resultFile + issueEntropy:resultForks ,
              data = Company_data, 
              model = "within")
summary(result1)
